const char SERVO_page[] PROGMEM = R"=====(
  ...
  <!-- <p>Steuerung eines RC-Servos &uuml;ber den Browser:</p>
  <p class="version">Version: <span id="id_version">0.00</span></p> -->
  <p>Steuerung eines RC-Servos &uuml;ber den Browser:
  <span class="version">Version: <span id="id_version">0.00</span></span></p>
  </div>
  <div class="row">
